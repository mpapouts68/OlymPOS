        ...
        private async Task<IEnumerable<Product>> GetAllFromRemoteAsync()
        {
            ...
            while (await reader.ReadAsync())
            {
                products.Add(new Product
                {
                    ...
                    VAT = reader.IsDBNull(reader.GetOrdinal("VAT")) ? null : reader.GetInt32("VAT"),
                    Build = reader.GetBoolean("Build"),
                    Extra_ID = reader.IsDBNull(reader.GetOrdinal("Extra_ID")) ? null : reader.GetInt32("Extra_ID"),
                    Row_Print = reader.GetInt32("Row_Print"),
                    Auto_Extra = reader.GetBoolean("Auto_Extra"),
                    Has_Options = reader.GetBoolean("Has_Options"),
                    Extra_ID_Key = reader.IsDBNull(reader.GetOrdinal("Extra_ID_Key")) ? null : reader.GetInt32("Extra_ID_Key"),
                    Menu_Number = reader.IsDBNull(reader.GetOrdinal("Menu_Number")) ? null : reader.GetInt32("Menu_Number"),
